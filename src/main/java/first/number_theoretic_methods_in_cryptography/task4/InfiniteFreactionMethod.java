...
import static first.number_theoretic_methods_in_cryptography.task4.Help.readFromFile;

public class InfiniteFreactionMethod {

    private static final String B_FILE = "/Users/aleksandr/5 курс 1 семестр/Code/src/main/java/first.number_theoretic_methods_in_cryptography/task4/B.txt";
    private static final List<BigInteger> B = readFromFile(B_FILE);
    private static final BigInteger TWO = new BigInteger("2");

    public static List<BigInteger> choiceBase(long m, int baseSize) {
    ...
    public static void expand(long m, int baseSize) {
        ...
        for (int i = 0; i < arraySize; i++) {
            ...
            if (x.compareTo(y) != 0) {
                ...
                if (gcd.compareTo(BigInteger.ONE) != 0) {
                    ...
                    System.out.print("Метод непрерывных дробей: " + gcd + " * " + factor);
                    return true;
                }
            }
        }
